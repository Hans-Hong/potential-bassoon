...
public class SelectedFileStreamingServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String filename = req.getParameter("filenames");
		...
		String encodingJson = URLEncoder.encode(selectedJson, "UTF-8");
		Cookie selectedCookie = new Cookie(Constants.SELECTEDFILE, encodingJson);
